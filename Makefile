main: main.cpp ./build/classes/GameScreen.class.o ./build/classes/CommonDrawingFX.class.o ./build/classes/Character.class.o
	g++ ./main.cpp ./build/classes/Character.class.o ./build/classes/CommonDrawingFX.class.o ./build/classes/GameScreen.class.o -o main -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio
